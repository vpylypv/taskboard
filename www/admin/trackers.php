...
if (getStringFromRequest('post_changes')) {
	...
	$first_column_by_default = getStringFromRequest('first_column_by_default','0');
...
<form action="/plugins/taskboard/admin/?group_id=<?= $group_id ?>&amp;action=trackers" method="post">
